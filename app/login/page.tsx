...
export default function LoginPage() {
  ...
  return (
    <main className="kada-pattern flex min-h-dvh items-center justify-center bg-black p-6">
      <div className="w-full max-w-md rounded-3xl border border-white/10 bg-black/80 p-6 shadow-[0_0_80px_rgba(34,197,94,0.12)]">
        <Logo size="login" />
